...
<template>
	<FieldRoot :invalid class="flex flex-col gap-1">
		...
		<Component
			...
			:autoresize="true"
			:type
			class="px-4 py-2 border-2 border-gray-800 rounded-lg border-solid bg-transparent resize-y placeholder:text-gray-600 disabled:cursor-not-allowed"
		/>
